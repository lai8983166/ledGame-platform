...
function closeKeyboard() {
  blurActiveEditableElement(document.activeElement);
  activeInput.value = null;
}
...
const onGlobalKeydown = (event: KeyboardEvent) => {
  if (isEditableEventTarget(event.target) && event.key !== "Escape") return;
